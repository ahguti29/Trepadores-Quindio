...
let TQ1 = cars.filter(car => car.categoria === "TQ1");
...
let TQ2 = cars.filter(car => car.categoria === "TQ2");
...
let TQ3 = cars.filter(car => car.categoria === "TQ3");
...
let TQ4 = cars.filter(car => car.categoria === "TQ4");
...
let TQ5 = cars.filter(car => car.categoria === "TQ5");
